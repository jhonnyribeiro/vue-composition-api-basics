<template>
  <div class="modals">
    <h1>Modals</h1>
    <div>
      <label>Show dark modals
        <input type="checkbox" v-model="showDarkModals"></label>
    </div>
    <button @click="showModal = true">Show modal</button>
    <component :is="showDarkModals ? ModalDark : Modal" v-model="showModal" title="Modal title via props">
